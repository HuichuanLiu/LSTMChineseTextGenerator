package word2vec;
/*
 * This class is provided as a tutorial of Standford CoreNLP
 * It exists here to provide properties of Chinese Standford pipeline, which can't be set manually for unknown reasons.
 */
